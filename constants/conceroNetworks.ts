...
export const conceroNetworks: Record<CNetworkNames, CNetwork> = {
    ...
    sepolia: {
        ...
        saveDeployments,
        chainId: 11155111,
        rpcs: rpcUrls.sepolia,
        url: rpcUrls.sepolia[0],
        accounts: [deployerPK, proxyDeployerPK],
        functionsDonId: process.env.CLF_DONID_SEPOLIA,
        functionsDonIdAlias: process.env.CLF_DONID_SEPOLIA_ALIAS,
        functionsRouter: process.env.CLF_ROUTER_SEPOLIA,
    ...
    baseSepolia: {
        ...
        saveDeployments,
        chainId: 84532,
        url: rpcUrls.baseSepolia[0],
        rpcs: rpcUrls.baseSepolia,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    avalancheFuji: {
        ...
        saveDeployments,
        chainId: 43113,
        url: rpcUrls.avalancheFuji[0],
        rpcs: rpcUrls.avalancheFuji,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    optimismSepolia: {
        ...
        saveDeployments,
        chainId: 11155420,
        url: rpcUrls.optimismSepolia[0],
        rpcs: rpcUrls.optimismSepolia,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    arbitrumSepolia: {
        ...
        saveDeployments,
        chainId: 421614,
        url: rpcUrls.arbitrumSepolia[0],
        rpcs: rpcUrls.arbitrumSepolia,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    polygonAmoy: {
        ...
        saveDeployments,
        chainId: 80002,
        url: rpcUrls.polygonAmoy[0],
        rpcs: rpcUrls.polygonAmoy,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    ethereum: {
        ...
        saveDeployments,
        chainId: 1,
        url: rpcUrls.ethereum[0],
        rpcs: rpcUrls.ethereum,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    polygon: {
        ...
        saveDeployments,
        chainId: 137,
        url: rpcUrls.polygon[0],
        rpcs: rpcUrls.polygon,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    avalanche: {
        ...
        saveDeployments,
        chainId: 43114,
        url: rpcUrls.avalanche[0],
        rpcs: rpcUrls.avalanche,
        accounts: [deployerPK, proxyDeployerPK],
    ...
    optimism: {
        ...
        saveDeployments,
        chainId: 10,
        url: rpcUrls.optimism[0],
        rpcs: rpcUrls.optimism,
        accounts: [deployerPK, proxyDeployerPK],
